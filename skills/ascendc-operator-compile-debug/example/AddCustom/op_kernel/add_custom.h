...
/*!
 * \file add_custom.h
 * \brief AddCustom operator implementation
 */
#ifndef ADD_CUSTOM_H
#define ADD_CUSTOM_H
...
template <typename T>
__aicore__ inline void AddCustom<T>::CopyIn(int32_t progress)
{
...
template <typename T>
__aicore__ inline void AddCustom<T>::CopyOut(int32_t progress)
{
...
template <typename T>
__aicore__ inline void AddCustom<T>::Compute(int32_t progress)
{
