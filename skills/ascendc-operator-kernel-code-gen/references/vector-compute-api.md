...
### 一元运算
```cpp
// Abs, Exp, Ln, Sqrt, Rsqrt, Reciprocal, Relu, LeakyRelu
...
| float | half | CAST_RINT / CAST_NONE |
| float | int32_t | CAST_RINT / CAST_ROUND |
